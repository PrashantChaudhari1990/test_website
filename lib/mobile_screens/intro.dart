...
import 'package:hoster/mobile_screens/sponsor_brands.dart';
...
class IntroScreenMob extends StatefulWidget {
  final String isTextstyleType;
  final String isDirectionType;
  const IntroScreenMob(
      {super.key,
      required this.isTextstyleType,
      required this.isDirectionType});

  @override
  State<IntroScreenMob> createState() => _IntroScreenMobState();
}

class _IntroScreenMobState extends State<IntroScreenMob> {
        ...
        child: Column(
          ...
          children: [
            ...
            Visibility(
                ...
                child: personImage()),
            SponsorListViewMob(isTextstyleType: widget.isTextstyleType),
          ],
        ),
      ),
    );
