...
class SponsorListView extends StatefulWidget {
  final String isTextstyleType;
  const SponsorListView({super.key, required this.isTextstyleType});

  @override
  State<SponsorListView> createState() => _SponsorListViewState();
}

class _SponsorListViewState extends State<SponsorListView> {
